package com.mehmettolgakutlu.travelbookjava.adapter;
...
public class CustomAdapter extends ArrayAdapter<Place> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext()); // xml ile bir kodu birbirine bağlamak için inflater kullanılır.
